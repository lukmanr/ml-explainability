...
class Explainer:
    ...
    def __ai_platform_predict(self, record):
    ...
    def __predict(self, record):
        ...
        predictions = self.__ai_platform_predict(pred_data)
    ...
    def __check_requisites(self):
        ...
        if not '_Explainer__gcp_model' in self.__dict__:
            raise Exception(
                'Please create an AI Platform client using create_ai_platform_client(...)')
